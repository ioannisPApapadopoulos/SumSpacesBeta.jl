...
function columns_supporter_functions(A, x, yU_2, yU_1, ywT0, ywT1, N, Nn; tol=1e-6)
    ...
    yu_1 = expansion(N, Nn, yu_1)
    yu_2 = expansion(N, Nn, yu_2)
    ywt0 = expansion(N, Nn, ywt0)
    ywt1 = expansion(N, Nn, ywt1)
    return (yu_2, yu_1, ywt0, ywt1)
end